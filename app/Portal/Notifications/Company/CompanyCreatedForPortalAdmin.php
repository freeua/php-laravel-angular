 ...
 */
class CompanyCreatedForPortalAdmin extends Notification
{
    /**
     * @var Company
     */
    ...
    /** @var string */
    private $emailKey = 'admin_created_for_portal_admin';
    ...
    public function toMail($notifiable)
    {
        ...
        //     ->markdown('mail.portal.company.admin-created-for-portal-admin', [
        //         'portalAdmins'  => $notifiable,
        //         'company'       => $this->company,
        //         'styles'        => $notifiable->getNotificationStyles(),
        //         'url'           => $notifiable->getFrontendFullUrl('login'),
