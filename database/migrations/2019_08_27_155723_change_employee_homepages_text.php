...
class ChangeEmployeeHomepagesText extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        DB::table('homepages')->where('type', \App\Portal\Models\Homepage::EMPLOYEE_DEFAULT_HOMEPAGE)->update([
            'items' => json_encode([
                ...
                'steps' => [
                    [
                        'title' => 'Angebot',
                        'description' => "Lassen Sie sich von Ihrem Fachhändler ein Angebot für Ihr Wunschrad direkt über das Dienstrad-Portal erstellen oder stellen Sie hier einen „{{go_to_new_offer}}“ und laden Sie das ausgehändigte Angebot Ihres Fachhändlers in Papierform hoch.",
                    ],
                    [
    ...
    public function down()
    {
        DB::table('homepages')->where('type', \App\Portal\Models\Homepage::EMPLOYEE_DEFAULT_HOMEPAGE)->update([
            'items' => json_encode([
                ...
                <p>In wenigen Schritten zu Ihrem Dienstrad:</p>",
                'steps' => [
                    [
                        'title' => 'Angebot',
                        'description' => "Lassen Sie sich von Ihrem Fachhändler ein Angebot für Ihr Wunschrad direkt über das Dienstrad-Portal erstellen oder stellen Sie hier einen „{{go_to_new_offer}}“ und laden Sie das ausgehändigte Angebot Ihres Fachhändlers in Papierform hoch.",
