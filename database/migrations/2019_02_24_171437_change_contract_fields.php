...
class ChangeContractFields extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        \Schema::table('contracts', function (Blueprint $table) {
            ...
            $table->float('accessories_price')->after('bike_discounted_price');
            $table->float('accessories_discounted_price')->after('accessories_price');
            $table->string('insurance_rate_name')->after('insurance_rate');
            $table->string('service_rate_name')->after('service_rate');
