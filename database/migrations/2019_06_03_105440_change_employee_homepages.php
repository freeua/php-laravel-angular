...
class ChangeEmployeeHomepages extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        DB::table('homepages')->where('type', \App\Portal\Models\Homepage::EMPLOYEE_DEFAULT_HOMEPAGE)->update([
            'items' => json_encode([
                ...
                'steps' => [
                    [
                        'title' => 'Angebot',
                        'description' => "Lassen Sie sich von Ihrem Fachhändler ein Angebot für Ihr Wunschrad direkt über das Dienstrad-Portal erstellen <u>oder</u> stellen Sie hier einen „Neuen Dienstrad-Antrag“ und laden Sie das ausgehändigte Angebot Ihres Fachhändlers in Papierform hoch.",
                    ],
                    [
