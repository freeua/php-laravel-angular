                    ...
                    <tr>
                        <td>
                            <p>
                                ...
                                Administratoren der Firma <i>{{$company->name}}</i> geändert.
                            </p>
                            <p>
                                @if($operation === 'add')
                                    Mitarbeiter {{$employee->first_name}} {{$employee->last_name}} ist jetzt ein
                                    Administrator mit der Berechtigung zum {{$permissions}}.
                                @endif
                                @if($operation === 'remove')
                                    Angestellter {{$employee->first_name}} {{$employee->last_name}} ist kein
                                    Administrator mehr
                                @endif
                            </p>
                        </td>
